...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_LoginWin_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_LoginWin_t qt_meta_stringdata_LoginWin = {
    {
QT_MOC_LITERAL(0, 8), // "LoginWin"
...
void LoginWin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LoginWin *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject LoginWin::staticMetaObject = { {
    ...
    qt_meta_stringdata_LoginWin.offsetsAndSize,
    qt_meta_data_LoginWin,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_LoginWin_t
, QtPrivate::TypeAndForceComplete<LoginWin, std::true_type>
